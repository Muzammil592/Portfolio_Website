...
import { Mail, MapPin, Github, Linkedin, ExternalLink, ArrowUp, Send } from "lucide-react";
  ...
  return (
    <SectionWrapper id="contact">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        >
          <div className="h-full rounded-xl border border-border/60 bg-card/60 backdrop-blur-sm p-6 space-y-6">
            ...
            <div className="border-t border-border/50 pt-5">
              ...
              <div className="flex gap-3">
                ...
                >
                  <Button variant="outline" className="gap-2 border-border/60 hover:border-primary/40 hover:text-primary transition-colors">
        ...
        >
          <div className="h-full rounded-xl border border-border/60 bg-card/60 backdrop-blur-sm p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-0">
                {[
                  ...
                  <div
                    ...
                    data-testid={`text-overview-${item.label.toLowerCase().replace(/\s/g, "-")}`}
                  >
      ...
      <footer className="mt-20 pt-8 border-t border-border/40" data-testid="footer">
